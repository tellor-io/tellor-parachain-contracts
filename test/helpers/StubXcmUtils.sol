...
contract StubXcmUtils {
    ...
    function weightMessage(bytes memory /* message */ ) external pure returns (uint64 weight) {
        return uint64(0);
    }
    ...
    function xcmExecute(bytes memory, /* message */ uint64 /* maxWeight */ ) external pure {
    ...
    function xcmSend(Multilocation memory, /* dest */ bytes memory /* message */ ) external pure {
