...
contract StubXcmTransactorV2 is XcmTransactorV2 {
    ...
    function indexToAccount(uint16 index) external view override
    returns (address owner) { return address(0x0); }

    function transactInfoWithSigned(Multilocation memory multilocation) external view override
    returns (
    ...
    function feePerSecond(Multilocation memory multilocation) external view override
    ...
    function transactThroughSigned(
        ...
        emit TransactThroughSigned(dest, feeLocationAddress, transactRequiredWeightAtMost, call, feeAmount, overallWeight);
    }
}